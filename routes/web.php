...
Route::get('ema','HamaedControler@index');
Route::get('users/{id}','HamaedControler@show');
Route::get('sum/{id}','HamaedControler@sum');
Route::get('kirkik','KirkikControler@index');
Route::get('kirkik/{id}','KirkikControler@show');
